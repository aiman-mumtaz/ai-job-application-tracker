...
**GCP stack:** Gemini for resume analysis and content generation, Cloud SQL for PostgreSQL for application and communication data, Cloud Storage for resumes, Cloud Tasks + Cloud Scheduler for automation, Identity Platform for authentication, and Cloud Run for deployment.
